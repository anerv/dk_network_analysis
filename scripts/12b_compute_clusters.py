...
# cluster_means_socio_net = analysis_func.examine_cluster_results(
#     socio_cluster_gdf,
...
# plot_func.style_cluster_means(cluster_means_socio_net)

# cluster_means_socio_net.to_csv(fp_socio_net_cluster_means, index=True)
...
# %%
# socio_cluster_gdf[["id", kmeans_col_net_socio, "geometry"]].to_postgis(
