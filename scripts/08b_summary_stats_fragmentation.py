...
for c, n in zip(comp_dfs, network_levels_steps):
    ...
    smallest_comp_size.append(c["infra_length"].min())
    mean_comp_size.append(c["infra_length"].mean())
    median_comp_size.append(c["infra_length"].median())
    max_comp_size.append(c["infra_length"].max())
    std_dev_comp_size.append(c["infra_length"].std())
