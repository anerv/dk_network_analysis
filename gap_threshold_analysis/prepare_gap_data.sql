...
DROP MATERIALIZED VIEW IF EXISTS gap_threshold_analysis.nodes_lts_1;

DROP MATERIALIZED VIEW IF EXISTS gap_threshold_analysis.nodes_lts_2;

DROP MATERIALIZED VIEW IF EXISTS gap_threshold_analysis.nodes_lts_3;

DROP MATERIALIZED VIEW IF EXISTS gap_threshold_analysis.nodes_lts_4;

CREATE INDEX IF NOT EXISTS gap_edges_geom_ix ON gap_threshold_analysis.edges USING GIST (geometry);

CREATE INDEX IF NOT EXISTS gap_lts_ix ON gap_threshold_analysis.edges (lts);

CREATE INDEX IF NOT EXISTS gap_source_ix ON gap_threshold_analysis.edges (source);

CREATE INDEX IF NOT EXISTS gap_target_ix ON gap_threshold_analysis.edges (target);

CREATE MATERIALIZED VIEW gap_threshold_analysis.nodes_lts_1 AS
SELECT
    DISTINCT node
FROM
    (
...
CREATE MATERIALIZED VIEW gap_threshold_analysis.nodes_lts_2 AS
SELECT
    DISTINCT node
FROM
    (
...
CREATE MATERIALIZED VIEW gap_threshold_analysis.nodes_lts_3 AS
SELECT
    DISTINCT node
FROM
    (
...
CREATE MATERIALIZED VIEW gap_threshold_analysis.nodes_lts_4 AS
SELECT
    DISTINCT node
FROM
    (
